...
class PreferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preference" do
    assert_difference('Preference.count') do
      post preferences_url, params: { preference: { course_taken: @preference.course_taken, description: @preference.description, grade: @preference.grade, grading_preference: @preference.grading_preference, student_id: @preference.student_id } }
    end
  ...
  test "should update preference" do
    patch preference_url(@preference), params: { preference: { course_taken: @preference.course_taken, description: @preference.description, grade: @preference.grade, grading_preference: @preference.grading_preference, student_id: @preference.student_id } }
